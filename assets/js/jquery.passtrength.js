;(function($, window, document, undefined) {
  ...
  var pluginName = "passtrength",
      defaults = {
        ...
        eyeImg : "https://oxyloans.com/new/assets/images/eye.svg"
      };
  ...
  Plugin.prototype = {
    init: function(){
      var _this    = this,
          ...
          tooltip = jQuery("<div/>", {class: "tooltip", text: "-Password shoud contain min 8-12 characters. - Password should have atleast a one number - Password should have atleast one Special character like @$#% - Password should have atleast one Capital Letter"});
