...
$(document).ready(function () {
	//baseUrl = "http://ec2-15-207-86-25.ap-south-1.compute.amazonaws.com:8080/oxyloans/";
	...
	if (userisIn == "local") {
		baseUrl =
			"http://ec2-15-207-86-25.ap-south-1.compute.amazonaws.com:8080/oxyloans/";
	} else {
	...
	$("#lendermobileverifybutton").click(function (event) {
		...
		if (mobileNumber.length == 10) {
			if (userisIn == "local") {
				var getStatUrl =
					"http://ec2-15-207-86-25.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/newregister";
			} else {
				var getStatUrl =
					"https://fintech.oxyloans.com/oxyloans/v1/user/newregister";
			}
			//var getStatUrl = "http://ec2-15-207-86-25.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/newregister";
	...
	$("#lenderpincode").on("keyup", function (e) {
		...
		if ($this.val().length == 6) {
			...
			//var getStatUrl = "http://ec2-15-207-86-25.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/"+pincode+"/pincode";
			if (userisIn == "local") {
				var getStatUrl =
					"http://ec2-15-207-86-25.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/" +
					pincode +
					"/pincode";
			} else {
				var getStatUrl =
