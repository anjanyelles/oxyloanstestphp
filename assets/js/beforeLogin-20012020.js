...
}, "You are not eligible for loan as your age is less than 18 yesrs.");
...
$("#lendermobileverifybutton").click(function(event){
   ...
   if(userisIn == "local"){
  var  getStatUrl = "http://ec2-13-232-202-148.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/newregister"
  }else{
  var  getStatUrl = "https://fintech.oxyloans.com/oxyloans/v1/user/newregister";
  } 
	  //var getStatUrl = "http://ec2-13-232-202-148.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/newregister";	  
...
$("#lenderfirstname,#lenderlastname,#firstname,#lastname").keypress(function (e) {
 ...
 $("#sucessotp").hide();
  ...
  rules: {	
    ...
    submitHandler: function() {
     ...
     var postData = {'mobileNumber':mobileNumber,"email":email,"emailOtp":emailotpvalue,'amountInterested':amt,"password":pass,"gender":gender};
 ...
 $("#sucessotp").hide();
  ...
  rules: {	
    ...
    // amt = parseInt(amt);
     ...
     var postData = {'mobileNumber':mobileNumber,"email":email,"emailOtp":emailotpvalue,"password":pass,"gender":gender};
...
$("#resetbtn").click(function(){
  ...
  $("#savebtn").click(function(){
    ...
    if(enteredPassword == "" && enteredcPassword == ""){
      ...
      $('.displayError-forgot').html("Password should contain min 8-12 characters.");
       $('.displayError-forgot').show();
       return false;
      ...
      $('.displayError-forgot').html("Please enter atleast one lower character.");
       $('.displayError-forgot').show();
       return false;
    }else if (!test_uppercases.test(enteredPassword )){
      $('.displayError-forgot').html("Please enter atleast one uppercase character.");
       $('.displayError-forgot').show();
       return false;
...
rules: {
  ...
  //user login api call//
   ...
   if(flag){
	    var postData = { "password": enteredPassword, "mobileNumber":enteredEmail };
   }else{
	   var postData = { "password": enteredPassword, "email":enteredEmail };  
   }          
   var postData = JSON.stringify(postData);
...
$(document).ready(function() {
  $( function() {
    var cities = ["Delhi", "Mumbai", "Kolkata", "Chennai", "Bangalore", "Hyderabad","Secunderabad" ,"Pune", "Visakhapatnam", "Vijayawada"];
