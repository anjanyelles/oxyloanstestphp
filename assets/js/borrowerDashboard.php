  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="pull-right">
        ...
        <a href="borrowerresponsestoMyrequests?appNumber=0" class="fl" style="display: none;">
          <button type="button" class="btn btn-outline graOutLine pull-right marR15"> <b>My Loan Offers</b> <i class="fa fa-bell alertnoOfLoanResponses"></i> <span class="noOfLoanResponses alertnoOfLoanResponses"></span>
        </button>
       </a>

        <a href="borrowerresponsestoMyrequests?appNumber=0" class="fl">
          <button type="button" class="btn btn-outline graOutLine pull-right marR15"> <b>Responses</b> <i class="fa fa-bell alertnoOfLoanResponses"></i> <span class="noOfLoanResponses alertnoOfLoanResponses"></span>
        </button>
       </a>

        <a href="borrowerraisealoanrequest">
          <button type="button" class="btn btn-success pull-right"id="hideloanrequest" ><i class="fa fa-angle-double-right"></i> <b class="btnNameofIncreaseLoan">Submit Loan Application</b>
          </button>
        </a>

       <a href="borrowerNewLoanRequests" >
          <button type="button" class="btn btn-success pull-right shownewLoan"><i class="fa fa-angle-double-right"></i> <b>New loan request</b>
          </button>
        </a>


           <a href="borroweragreedloans">
              <button type="button" class="btn btn-primary pull-right marR15"><i class="fa fa-angle-double-right"></i> <b>Agreed Loans</b>
            </button>
           </a>
      </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Offer Available  : <span class= "loanAmountPending"></span></p>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Reached maximum limit. Please<a href="borrowerraisealoanrequest" style="color: red;"> click here </a>to  increase loan amount.</p>
              </div>
...
<div class="modal modal fade" id="displayApplicationInfo">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <table border="1" width="100%" style="font-family: arial, sans-serif; border-collapse: collapse;width: 100%; background:#fff;">
