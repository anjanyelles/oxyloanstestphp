...
<?php
  ...
  $utmValue =  isset($_GET['utm']) ? $_GET['utm'] : 'WEB';
   ...
   // echo "<script>alert('$lenderuniquenumber');</script>";
    // echo "<script>alert('$utmValue');</script>";
        ...
        <div class="container">
            <div class="middle-block">
                <div class="form-block1 block-loan">
                    ...
                    <div class="newRefBox"
                        style="display:flex; justify-content: center; align-items:center; font-size: 16px; font-family:sans-serif;">
                    ...
                    <form id="lendermobileSection" autocomplete="off" method="post" style="display:none">
                        <div class="lenderstep1 mar15">
                            ...
                            <div class="form-lft">
                                ...
                                <div class="fld-block">
                                    <input type="text" placeholder="Last Name as per PAN card" id="lenderlastname"
                                        name="lenderlastname" class="text-fld1">
                            ...
                            <div class="form-lft">
                                ...
                                <div class="fld-block">
                                    ...
                                    <div class="mobile22">
                                        <input type="text" placeholder="xxx-xxx-xxxx" id="lmobileNumber"
                                            name="lmobileNumber" class="mobile2">
                                    </div>
                                    <input type="" style="display: none;" class="form-control lenderuserType"
                                        placeholder="Enter amount" id="lenderuserType" name="lenderuserType"
                                        value="LENDER">
                                    ...
                                    <div class="verify_btn">
                                        ...
                                        <!--  <img src="<?php echo base_url(); ?>assets/images/verify.png" alt="arrow" id="lendermobileverifybutton"> -->
                                        <button type="button" class="btn  btn-success btn-textchange"
                                            id="lendermobileverifybutton">
                            ...
                            <div class="form-lft">
                                <label>OTP<i>*</i></label>
                                <div class="fld-block">
                                    <input type="text" placeholder="OTP" id="lenderotpvalue" name="lenderotpvalue"
                                        class="text-fld1">
                            ...
                            <div class="form-lft">
                                ...
                                <div class="fld-block">
                                    <input type="text" placeholder="PIN Code" id="lenderpincode" name="lenderpincode"
                                        class="text-fld1">
                                    <div class="clear"></div>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="form-lft ">
                                ...
                                <div class="fld-block citydrop">
                                    <select name="locality" id="lenderlocalityValue" class="form-control">
                            ...
                            <div class="form-lft form-mob">
                                ...
                                <div class="fld-block citydrop">
                                    <select name="lendercity" id="lendercityValue" class="form-control">
                                    ...
                                    <input type="text" name="lenderothers" class="cityValue" id="lenderothers"
                            ...
                            <label>City<i>*</i></label>
                            <div class="fld-block">
                                <input type="text" placeholder="City" name="lendercity" class="text-fld1" id="lendercityValue" readonly="true">
                                <div class="clear"></div>
                            </div>
                            <div class="clear"></div>
                        </div> -->
                            <div class="form-lft form-otp">
                                ...
                                <div class="fld-block">
                                    <input type="text" placeholder="State" class="text-fld1" name="lenderstateValue"
                                        id="lenderstateValue" readonly="true">
                                    <div class="clear"></div>
                                </div>
                                <div class="clear"></div>
                            </div>
                    ...
                    <form id="lenderemailSection" autocomplete="off" method="post">
                        ...
                        <div class="clear"></div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-success btn-textchangeforwhatsapp"
                                                id="lenderwhatsappverifybutton">Send OTP</button>
                                        </span>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            ...
                            <div class="form-lft lwhatsappOtpHide" style="display: none;">
                                <label>Whatsapp OTP</label>
                                <div class="fld-block">
                                    <input type="text" type="text" placeholder="WhatsApp OTP" name="lwhatappotpvalue"
