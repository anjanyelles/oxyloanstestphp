                                             ...
                                             <div class="panel-body " id="userKYCUpload" enctype="multipart/form-data">
                                                     ...
                                                     <div class="col-lg-12">
                                                         ...
                                                         <table
                                                             ...
                                                             <tbody>
                                                                 ...
                                                                 <!----------------->
                                                                 <tr>
                                                                     <th>Confirm Account No :<em
                                                                             class="mandatory">*</em></th>
                                                                     <td>
                                                                         <div class="fld-block account_form">
                                                                             <span
                                                                             ...
                                                                             <span
                                                                                 class="error oxyconfirmaccountnoError"
                                                 ...
                                                 <div>
                                                     <button type="button"
                                                         ...
                                                         id="user-bank-verify" style="margin-left:60px"><i
                                                             class="fa fa-bank"></i> Verify</button>

                                                     <button type="button"
                                                         class="btn btn-danger pull-left deactivate-btn"
                                                         id="user-bank-save" style="display: none; margin-left: 50px;">
                                                         Save</button>
