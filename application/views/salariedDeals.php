    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="pull-right col-md-8 mobileDiv_2">
                ...
                <!--  <a href="https://sites.google.com/view/participation-in-deal/home" target="_blank" class="pull-right">
                    <button class="runningDeals-Btn btn btn-danger btnRoundUp">
                      Help
                    </button>
                </a> -->

                <a href="salariedDeals?status=running" class="runningDeals-Btn pull-right">
                    <button class=" btn btn-success btnRoundUp">
                        Personal Running Deals
                    </button>
                </a>

                <a href="salariedDeals?status=closed" class="compleated-Btn pull-right">
                    <button class=" btn btn-warning btnRoundUp">
                        Personal  Closed Deals
                    </button>
                </a>
                <a href="viewmyDeals" class="compleated-Btn pull-right">
  ...
  <tr class="deal-{{fundingStatus}} divBlock_Mob_001">
    <td class="dealName numeric knowAtmType">
      <span class="mobile_res earningbloack"><b>Deal Name:</b> {{dealName}}
       ...
       <span class="mobile_View_Hide"><b>Deal Id:</b> {{dealId}}  <br/> </span>

            <span class="borrowersId_{{borrowersMappedStatus}} mobile_View_Hide"> 
                   <br/> 
             <b>Borrower Ids:</b>
             ...
             {{#borrowerId}}
              ...
              {{/firstParticipationDate}} 
                ...
                <br/>
               <span class="mobile_View_Hide"><b>Last Participated :</b> {{lastParticipationDate}} </span> <br/>
               {{/lastParticipationDate}}
          ...
          <!--       {{#monthlyInterest}}
               ...
               <span class="mobile_View_Hide class="withdraw_roi_{{withdrawStatus}}" style="display:none" }}"><b>Withdrawal ROI:</b> {{roiForWithdraw}}  % </span>
                </p>
                <i class="fa fa-info-circle fl myinfos mobile_View_Hide pull-right isAtmInfo atmInfo_{{withdrawStatus}}" data-toggle="tooltip" data-placement="left"
...
window.onload = viewEquityDeals('<?php echo $dealStatus;  ?>', "PERSONAL");
...
$(document).on("load", ".isAtmInfo", function() {
    $(".isAtmInfo").each(function() {
        let isAtmInfo = $(".isAtmInfo");
        console.log(isAtmInfo);
