                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr id="example">
                                    ...
                                    <?php if ($userType === 'ADMIN' || $userType === 'MASTERADMIN'): ?>
                                        <th>Amount & ROI</th>
...
<td class="user-ViewDocs{{lenderUser.id}}">
        ...
        <?php if ($userType === 'ADMIN' || $userType === 'MASTERADMIN'): ?>
         ...
         <button type="button" class="btn btn-warning pull-left btn-xs" onclick="changePrimarytype('BORROWER',{{lenderUser.id}})" data-reqid = "{{lenderUser.id}}" > <b>Change to Borrower</b></button>
          <br> <br>
          <button type="button" class="btn btn-info pull-left btn-xs" onclick="changeLenderTestType({{lenderUser.id}})" data-reqid = "{{lenderUser.id}}" ><b>Change to Test Lender</b></button><br> <br>
