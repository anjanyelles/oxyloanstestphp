                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="col-md-6 runningheader">
                            <a href="HelpDesktestDeals?status=running">
                                <button class=" btn btn-success btnRoundUp" style="border-radius: 5px;">
                                    Test Running Deals <i class="fa fa-angle-double-right"></i>
                                </button>
                            </a>

                            <a href="HelpDesktestDeals?status=closed" class="compleated-Btn">
                                <button class=" btn btn-warning btnRoundUp"
                                    style="border-radius: 5px; margin-left: 10px;">
                                    Test Closed Deals <i class="fa fa-angle-double-right"></i>
                                </button>
                            </a>
                        </div>
