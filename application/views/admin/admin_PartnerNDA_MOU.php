...
<div class="content-wrapper">
                                                    ...
                                                    <div class=" col-lg-12">
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th>Company Address<em class="mandatory">*</em></th>
                                                                    <td>
                                                                        <div class="fld-block account_form">
                                                                            <span
                                                                                class="displayoxyscore udisplaysecautoinvest"></span>
    ...
    color: #000">
                                                                        ...
                                                                        <!-- <input type="text"data-toggle="tooltip" title="900-good"placeholder="Please Enter Type of Document" id="type" > -->
                                                        ...
                                                        <td>
                                                            <div class="fld-block account_form">
                                                                <span
                                                                    class="displayoxyscore udisplaysecautoinvest"></span>
                                                                <input type="text" data-toggle="tooltip"
                                                                    title="900-good" placeholder="Please enter Services"
                                                                    id="services">
                                                                <span class="error errorservices"
                                                                    style="display: none;">Please enter Services.</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <!----------------->
