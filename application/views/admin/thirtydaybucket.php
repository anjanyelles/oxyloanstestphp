        ...
        <div class="row">
            ...
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn"
                    onclick="searchforBucketdays(1,30,'30days')">
                    ...
                    <div class="box-body">
                        ...
                        <div class="fright">
                            <button class="btn btn-success" class="downloadReport"
                                onclick="download30daysReport();">Download Report</button>
                        </div><br>
...
<script id="loadBorrowersListTpl" type="text/template">
   ...
   <td><a href="javascript:void(0)" class="viewLoanLendersforbuckets"onclick="viewbucketLoanLenders(1,30,'30days',{{borrowerUser.id}})" >View Loans</a></td>
  ...
  <td style="display:none;" colspan="14" class="viewbucketLoanLenders viewbucketLoanLenders-{{borrowerUser.id}}">
      ...
      <div class="col-md-6 pull-right">
       ...
       <table class="table table-bordered table-hover">
          ...
          <th>30days bucket pending EMI's</th>
              </tr>
              </thead>
...
<script id="loadLendersbucketloans" type="text/template">
    {{#data}}
      ...
      <td>LR{{lenderUser.id}}<br/>{{lenderUser.firstName}} {{lenderUser.lastName}}</td>
        ...
        <td><a href="javascript:void(0)" class="viewDelayEMIcard" onclick="viewDelayEMIcard(1,30,'30days','{{id}}');">View 30days bucket delay EMI</a>
        </td>
      </tr>
  {{/data}}
</script>
...
<div class="modal modal-success fade" id="modal-thirtydaysbucketdownload">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                Thirty days bucket downloaded Successfully .
            </div>
...
window.onload = loadPndingbucketsApplications(1, 30, "30days");
