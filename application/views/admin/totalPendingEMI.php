...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn" onclick="searchsforpendingEmis('total')">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="col-md-6">
                            <h3 class="box-title">total Months Pending EMIs</h3>
                        </div>
...
<script id="loadPendingEMIsListTpl" type="text/template">
    {{#data}}
      ...
      <td><a href="javascript:void(0)" class="viewLoanLendersforpendingemis"onclick="viewLoanLendersforpendingemis('total',{{borrowerUserId}})" >View Loans</a></td>
      </tr> 
<tr>
...
<script id="loadLenderspendingemisloans" type="text/template">
    {{#data}}
      ...
      <td>LR{{lenderUser.id}}<br/>{{lenderUser.firstName}} {{lenderUser.lastName}}</td>
        ...
        <td><a href="javascript:void(0)" class="viewPendingEMIcard" onclick="viewPendingEMIcard('total',{{id}})">View EMI</a>
        </td>
      </tr>
  {{/data}}
</script>
...
window.onload = loadPendingEMIsList('total');
</script>
