    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="pull-right col-md-6">
                <a href="userQueryDetails?queryStatus=pending&primaryType=LENDER">
                    <button class=" btn btn-success btnRoundUp" style="border-radius: 20px;">
                        Pending Lender Queries
                    </button>
                </a>
                <!-- <a href="userQueryDetails?queryStatus=pending&primaryType=BORROWER" class="compleated-Btn">
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="col-md-6">
                            <b><span class="userPendingQuery"></span>
                                : <span class="countofpendingquery"></span></b>
                        </div>
    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          ...
          {{#.}}
          <li class="listPendingqueries">

        <b> Query :   </b>  {{pendingQuereis}} </br>
         <b> Respond  By  </b> :<span class="responded_user">{{respondedBy}}</span>     </br>
        <b>   Respond  on  </b> :   {{respondedOn}}</br>
