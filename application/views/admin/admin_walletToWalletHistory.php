...
$requestStatus =  isset($_GET['status']) ? $_GET['status'] : 'TEST';
...
<script type="text/javascript">
    <?php
        $requestStatus = "LIVE";
        if ($userType == "MASTERADMIN" || $userType == "TESTADMIN") {
            $requestStatus = "TEST";
        }
    ?>
    window.onload = function() {
        w2wWithdrawalhistory("<?php echo $requestStatus; ?>");
    };
</script>
