        ...
        <div class="row">
            ...
            <div class="pull-right col-md-9 mobileDiv_2">
                ...
                <!--        <a href="https://sites.google.com/view/participation-in-deal/home" target="_blank">
                    <button class="runningDeals-Btn btn btn-danger btnRoundUp pull-right">
                    Help
                    </button>
                </a> -->

                <a href="escrowDeals?status=running" class="runningDeals-Btn">
                ...
                <a href="escrowDeals?status=closed" class="compleated-Btn">
                    <button class=" btn btn-warning btnRoundUp pull-right">
