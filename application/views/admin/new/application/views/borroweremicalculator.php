        ...
        <div class="row">
            <div class="box col-xs-12 box-primary">
                <div class="box-header">
                    <div class="col-md-3 pull-left calEmiHeader">
                        <h4 style="font-family: sans-serif;">Calculate Your Emi <i class="fa fa-calculator"
                                aria-hidden="true" style="margin-left: 6px;"></i></h4>
                        <hr style="width: 75%;">
                        </hr>
