        ...
        <div class="container">
            <div class="middle-block">
                <div class="form-block1 block-loan">
                    ...
                    <form id="lendermobileSection" autocomplete="off" method="post">
                        <div class="lenderstep1">
                            ...
                            <div class="form-lft">
                                ...
                                <div class="fld-block">
                                    ...
                                    <div class="verify_btn">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/verify.png" alt="arrow"
                            ...
                            <div class="form-lft form-mob">
                                ...
                                <div class="fld-block citydrop">
                                    <select placeholder="Select City" name="lendercity" id="lendercityValue"
                                        class="form-control">
                        ...
                        <div class="lenderstep2" style="display:none">
                            ...
                            <div class="form-lft">
                                ...
                                <div class="fld-block verify_block">
                                    ...
                                    <div class="verify_btn"><img src="<?php echo base_url(); ?>assets/images/verify.png"
                                            alt="arrow" id="lenderemailverifybutton">
