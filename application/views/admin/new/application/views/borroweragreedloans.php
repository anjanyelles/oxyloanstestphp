...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-right mobile_View_div">
            ...
            <a href="borrowerresponsestoMyrequests?appNumber=787" class="viewLendersOffers mobile_View_Hide">
  ...
  <tr class="divBlock_Mob_001">
    ...
    <td>
      <span class="lable_mobileDiv">repaymentMethod</span>
    {{repaymentMethod}}</td>
    <td><span class="lable_mobileDiv">roi</span>{{rateOfInterest}}<span style='display:none' class="loanTypeisI loanTypeis{{borrowerUser.commentsRequestDto.durationType}} "> % Per Month</span>
...
{{/data}}
    ...
    <div class="modal modal-success fade" id="modal-agreement-downloaded">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <p>Your agreement has been successfully downloaded.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                </div>
