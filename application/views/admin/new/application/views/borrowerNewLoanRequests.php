                            ...
                            <div class="col-xs-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="loanRequestAmount"
                                            ...
                                            id="newloanRequestAmount" data validation="loanRequestAmount"
                                            required="required">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <label>
                                            <input type="radio" id="principleMethod" name="newrepaymentMethod"
                                                value="PI" />
                                        ...
                                        <br />
                                        <label>
                                            <input type="radio" id="interestMethod" name="newrepaymentMethod"
                                                value="I" />
                                        ...
                                        <div class="input-group date" data-date-format="dd/mm/yyyy">
                                            ...
                                            <div class="input-group-addon">
                                                <span class="fa fa-info-circle pointerStyle"
                                                    title="Select from which date you want to get loan"></span>
                                            </div>
                                        </div>
                                ...
                                <center> <button type="button" class="btn btn-lg btn-primary"
                                        id="newloan-submit-btn">Submit</button>
                                </center>
                            </div>
                        </form>
                        <div class="col-xs-1"></div>
...
<div class="modal modal-warning fade" id="modal-offerAmountNotfullFilled">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <p class="text">Your offered amount is not full filled.You can not raise a loan request.</p>
            </div>
            <div class="modal-footer">
...
<div class="modal modal-warning fade" id="modal-updateexistingoffer">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <p id="text">You can not raise a loan rquest/offer again instead update existing one.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
            </div>
