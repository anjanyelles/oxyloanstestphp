...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-3 text-center">
                <input type="text" name="fieldName" class="form-control  fieldName" placeholder="fieldName"
                    id="fieldName">
            </div>
            <div class="col-xs-3 text-center">
                <input type="text" name="fieldValue" class="form-control  fieldValue" placeholder="fieldValue"
                    id="fieldValue">
            </div>
            <div class="col-xs-3 text-center">
                <input type="text" name="operator" class="form-control operator" placeholder="operator" id="operator">
            </div>
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left" id="Search-btn"><i
                        class="fa fa-angle-double-right"></i> <b>Search</b></button>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">My Loan Requests</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="myborrowingsData" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="javascript:void(0)">APBR101906</a></td>
                                    <td>2,00,000</td>
                                    <td>1,63,000</td>
                                    <td>6,222.22</td>
                                    <td>20-Dec-2017</td>
...
window.onload = loanrequestsData;
</script>
