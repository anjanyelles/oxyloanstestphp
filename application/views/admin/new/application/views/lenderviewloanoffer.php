...
<?php
  ...
  //$requestPageNo =  $_GET['pageNo'];
  //$requestorderNo = $_GET['requestorderNo'];
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <span class="requestPageNo "><?php // echo  $requestPageNo; ?></span>
            <span class="requestorderNo "><?php // echo $requestorderNo; ?></span>
        ...
        <div class="pull-left">
            <small>
                <ol class="breadcrumb">
                    <span class="toImLending"></span> needs INR <span class="loanRequestAmountDisplay"></span> and got
                    funded INR <span class="disbursedAmount"></span> from other lenders and still she/he requires INR
                    <span class="balAmountDisplay"></span>.
                </ol>
            </small>
        </div>
                ...
                <div class="box viewLoanOfferSection">
                    <div class="box-body no-padding ">
                        ...
                        <div class="box-header">
                            <div class="col-md-12 borrowerUserInfo">
                                <div class="col-md-6">
                                    ...
                                    <b>Risk Category:-</b> <span class="borrowerRiskCat"></span> <br />
                                </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>4.</td>
                                <td>Disbursed amount from other lenders</td>
                                <td>
                                    <span class="disbursedAmount"></span>
                                    <span class="balAmountDisplay" style="display: none;"></span>
                                    <span class="displaySuggetionMessageBorrower" style="display: none;"></span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Loan Duration</td>
                                <td>
                                    <span class="durationDisplay"> 24</span> <span class="Duration"></span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="rateOfInterestDisplay"> 16.00% </span> <span class="valuedisplay">Per
                                        day </span>
                            ...
                            <tr>
                                ...
                                <td>Description</td>
                                <td>
                                    <span class="loanPurposeDisplay"> Personal Loan</span>
                                </td>
                            </tr>
                            ...
                            <div align="right" class="col-md-5">
                                <a href="javascript:void(0)" class="lenderSendingOffer">
                                    <button type="button" class="btn btn-success pull-right" data-toggle="tooltip"
                                        title="Max you can offer INR 50000 to one Borrower"><i
