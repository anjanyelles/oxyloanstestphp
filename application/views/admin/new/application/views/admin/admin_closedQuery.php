...
$queryStatus =  isset($_GET['queryStatus']) ? $_GET['queryStatus'] : 'Cancelled';
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="pull-right col-md-6">
                <a href="closedQuery?queryStatus=Cancelled&primaryType=LENDER">
                    <button class=" btn btn-success btnRoundUp" style="border-radius: 20px;">
                        Cancelled Lender Queries
                    </button>
                </a>
                <a href="closedQuery?queryStatus=Cancelled&primaryType=BORROWER" class="compleated-Btn">
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="col-md-6">
                            <b><span class="userClosedQuery"></span>
                                : <span class="countclosedquery"></span></b>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <textarea type="text" name="" class="form-control queryComments" placeholder="Enter The Comments"></textarea>
                        <span class="error commentsErrorMessage">Enter The comments</span>
                        </div>
  ...
  {{/data}}
    ...
    <tr>
      ...
      <td>
        <button class="btn btn-xs btn-success btn-query-{{status}}" onclick="queryApproveandUpdateComments({{id}},{{userId}},'Completed');"> Resolve  </button>
        </br>
        <button class="btn btn-xs btn-danger btn-query-{{status}}"  onclick="queryApproveandUpdateComments({{id}},{{userId}},'Pending');"style="margin-top:10px;"> Pending </button>
        </br>

        <button class="btn btn-xs btn-primary btn-query-{{status}}"  onclick="subinquiries({{id}},{{userId}});"style="margin-top:10px;"> Ticket History </button>
