                               ...
                               <div class="row">
                                ...
                                <div class="col-md-3 mb-3 formTopRows">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <span class="error dealloanamounterror" style="display: none;">Enter The Loan Amount</span>
                                </div>
                                <div class="col-md-3 mb-3 formTopRows">
                                ...
                                <div class="col-md-3 mb-3 formTopRows">
                                    ...
                                    <div class="input-group">
                                     ...
                                     <span class="error dealstartDateerror" style="display: none;">Please Enter The start date</span>
                                </div>
                                ...
                                <div class="col-md-3 mb-3 formTopRows">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="error dealEndDateerror" style="display: none;">Please Enter The End date</span>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <span class="error dealDurationError" style="display: none;">Enter Deal Tenure</span>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="error participationmaxLimiterror" style="display: none;">Enter the
                                                max Amount</span>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <code><small>Note:user's id seperated By ','</small></code>
                                          ...
                                          <span class="error borrowermappedIdError" style="display: none;">Please Enter Borrower ids</span>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <code><small>Loan amount seperated By ','</small></code>
                                          <span class="error borrowermappedloanamount" style="display: none;">Please Enter Borrower Mapped Amount</span>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control participcationLenderType col-md-3"
                                                ...
                                                validation="participcationLenderType" id="participcationLenderType" onchange="choosenparticipationLenderType();">
                                            <option value="">-- Choose option-----</option>
                                                <option value="NEW">NEW LENDER</option>
                                                <option value="ANY" selected>ANY LENDER</option>
                                            </select>
                                     ...
                                     <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control feeParticipation" name="feeParticipation" data
                                                validation="feeParticipation" id="feeParticipation" onchange="choosenparticipationfeeType();">
                                                <option value="">-- Choose options-----</option>
...
<div class="modal fade" id="createdealOverfeeeModalBox" role="dialog"
            ...
            <div class="modal-body">
                <div class="thank-you-pop">
                    <img src="<?php echo base_url(); ?>/assets/images/yellow-circle-info.jpg" width="100" alt="">
                     <h3 class="text-center">Please review the Deal Details!</h3>
                      <div class="bodyContentNewPopUp">
                        <label>Deal Amount :- INR </label> <span class="amountLendEntered"></span></b><br />
                        <label>Deal Name :-</label> <span class="dealNamePop">Deal Nadergul</span></b><br />
                        <label>ROI :-</label><span class="dealRoI"></span>
                         , <label>Payout : </label> <span class="tupeOfInt">Monthly , </span>  <br />
                        <label>Min : </label> <span class="tupeOfIntmin"> </span>,
                        <label>Max : </label> <span class="tupeOfIntMax"></span><br />
                    </div>
                    <div class="clear"></div>
                    <div class="popbtns">
                    <button type="button" class="btn btn-success btn-lg yesBTN4Deal" data-reqID="" data-type=""
                            onclick="confimcreateAdeal('<?php echo $dealId?>','<?php echo $loanRequestID?>',false)">Yes, Confirm & Create </button>
                    </div>
...
<div class="modal  fade" id="isTestDealCreation">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="#">Are you sure you want to create/Edit a test deal? </p>
            </div>
            <div class="modal-footer">
                <div align="right">
                    <button type="button" class="btn btn-sucess btn-sm" id="testDealCheck" onclick="">Create/Edit</button>
