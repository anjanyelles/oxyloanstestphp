                        ...
                        <div class="main-cont createDealFormSection">
                            ...
                            <div class="row submissionPart">
                                ...
                                <button class="btn btn-success btn-lg pull-right" type="submit"
                                    onclick="createAdeal('<?php echo $dealId?>')" style="margin-top:15px;">Next</button>
            ...
            <div class="modal-body">
                <div class="thank-you-pop">
                    ...
                    <div class="bodyContentNewPopUp">
                        ...
                        <label>Deal Name :-</label> <span class="dealNamePop"></span></b><br />
                        <label>ROI :-</label> <span class="dealRoI"></span>
                         ,<label>Payout : </label> <span class="tupeOfInt">  </span>  <br />
                    ...
                    <div class="popbtns">
                        <button type="button" class="btn btn-success btn-lg yesBTN4Deal" data-reqID="" data-type=""
                            onclick="confimcreateAdeal('<?php echo $dealId?>','<?php echo $loanRequestID?>', false)">Yes, Confirm & Edit </button>
...
<div class="modal  fade" id="isTestDealCreation">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="#">Are you sure you want to create/Edit a test deal?
                </p>
            </div>
            <div class="modal-footer">
                <div align="right">
