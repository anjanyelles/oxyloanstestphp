        ...
        <div class="row">
            <div class="col-xs-2 text-center">
                <select class="form-control choosenType" id="Search">
                    ...
                    <option value="interestMonth&YearNew">MONTH&YEAR</option>
                </select>
            ...
            <div class="col-xs-2 text-center interestEndDateKNOW" style="display: none;">
                <select class="form-control" id="interestEndDatevalKnow">
            ...
            <div class="col-xs-1 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn"
                    onclick="getInterestInformationsearch('<?php echo$status?>');"><i class="fa fa-angle-double-right"></i>
                    <b>Search</b>
                </button>
            </div>
        </div>
...
<script  id="displayshowinterestInfoScript" type="text/template">
    {{#data}}
     ...
     <tr class="showinterestPaymentinquery-{{paymentDate}}">
         ...
         <td>
            <b> Deal Name</b> :{{dealName}}
          </br>
        <b>Deal Id</b>:{{dealId}}</br>
          <b>Deal Value</b>  :{{totalDealValue}} </br>
         <b>ROI</b>:{{rateOfInterest}} % 
         </td>

         <td>
            <b>PaymentDate </b>:{{paymentDate}}</br>
            <b>Deal Status</b>: {{dealStatus}}
         ...
         <td>
          ...
          <a class="viewLenders" href="viewDealLenders?id={{dealId}}& dealName={{dealName}}" target="_blank"><button class="btn btn-success btn-large">View Lenders</button></a>
           ...
           <button class="btn btn-large bg-info btn-primary" onclick="viewCurrentInterestAmount({{dealId}},'{{paymentDate}}');"> Interest View </button>
    ...
    <td style="display:none;" colspan="14" class="viewQueryadminStatus  solidToggle_{{dealId}}">
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody id="displayUserShowinterestInfo-{{dealId}}">

        <tr class="viewQueryAdminComments_{{dealId}}" style='display:none'>
        <td colspan="12">
          No data Found
        </td>
...
<script id="displayshowinterestSubInfoScript" type="text/template">
    {{#data}}
    
      <tr class="showinterestPaymentinquery-{{dealId}}">
...
window.onload = getInterestInformation(`<?php echo$status ?>`);
</script>
<script type="text/javascript">
