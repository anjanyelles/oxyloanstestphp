                                    ...
                                    <div class="row col-xs-12">
                                        <div class="col-xs-6">
                                            ...
                                            <select class="form-control" id="fdlead">
                                                ...
                                                <option value="RAMESH REDDY">RAMESH REDDY</option>

                                                    <option value="ZUBEIDHA">ZUBEIDHA</option>
...
<select name="consultancy_name" class="form-control" id="fdconsultancy">
    ...
    <option value="SKILL FORD">SKILL FORD</option>
    <option value="INDOCAN OVERSEAS PVT LTD">INDOCAN OVERSEAS PVT LTD</option>
