                 ...
                 <div class="box box-primary">
                         ...
                         <div class="pull-left col-md-12">
                             ...
                             <div class="col-md-3 pull-left">
                                 <button class="btn btn-danger btn-lg btn4ReferralPayment pull-right"
                                     ...
                                     title="Download Referral Amount Statement" data-placement="right"
                                     target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download
                                     Statement</button>
                     ...
                     <div class="box-body">
                         <div class="select_Box pull-right mobile_Select">
                             ...
                             <select class="form-select myformSelcInvestments myEarningStatus"
                                 id="myformSelcInvestments" aria-label="Default select example">
     ...
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             <div class="modal-header">
                 ...
                 <div class="row">
                     <div class="col-xs-9">
                         <h4 class="modal-title">Payment Status Info</h4><br /><b>If you have any queries please write
                             to us
                             <a
                                 href="https://oxyloans.com/new/lenderInquiries">https://oxyloans.com/new/lenderInquiries</a></b>
                     </div>
