 ...
 <div class="content-wrapper">
     ...
     <section class="content">
         <div class="row">
             ...
             <a href="partnerLenderList" style="color:black;">
                 ...
                 <div class="col-xl-3 col-sm-3 mb-xl-0 mb-4">
                     <div class="card info-card">
                         <div class="card-body p-3">
                             ...
                             <div class="col-md-7">
                                 <div class="numbers">
                                     <p class="text-sm mb-0 text-uppercase font-weight-bold">Today's Lender</p>
                                     <h5 class="font-weight-bolder registerLenders">
                                         4
                                     </h5>
                                     <p class="mb-0">
                                         <span class="text-success text-sm font-weight-bolder">Total Lenders
                                         </span></br>
                                         <span class="totalregisterLenders">2</span>
                                     </p>
                                 </div>
                             </div>
             ...
             <a href="partnerListUsers" style="color:black;">
                 <div class="col-xl-3 col-sm-3 mb-xl-0 mb-4">
                     <div class="card">
                         <div class="card-body p-3">
                             ...
                             <div class="col-md-7">
                                 <div class="numbers">
                                     <p class="text-sm mb-0 text-uppercase font-weight-bold">Today's Borrower</p>
                                     <h5 class="font-weight-bolder registerBorrower">
                                         53,000
                                     </h5>
                                     <p class="mb-0">
                                         <span class="text-success text-sm font-weight-bolder">Total Borrower
                                             :</span></br>
                                         <span class="totalregisterborrower">2</span>
                                     </p>
                                 </div>
                             </div>
                     ...
                     <div class="card-body p-3">
                         ...
                         <div class="col-md-7">
                             <div class="numbers">
                                 ...
                                 <h5 class="font-weight-bolder runningLoansCount">
                                     $53,000
                                 </h5>
                                 <p class="mb-0">
                                     <span class="text-success text-sm font-weight-bolder">Running Amount</span></br>
                                     <span class="runningLoansAmount">2</span>
                                 </p>
                             </div>
                         </div>
                     ...
                     <div class="card-body p-3">
                         ...
                         <div class="col-md-7">
                             <div class="numbers">
                                 ...
                                 <h5 class="font-weight-bolder closedLoansCount">
                                     $53,000
                                 </h5>
                                 <p class="mb-0">
                                     <span class="text-success text-sm font-weight-bolder">Disbursed Value</span></br>
                                     <span class="totalDisbursedAmount">2</span>
                                 </p>
                             </div>
                         </div>
             ...
             <div class="col-md-12 investmentSection">
                 ...
                 <div class="box box-primary" style="margin-top:0px!important">
                     <div class="box-header with-border">
                         <h3 class="box-title">My Earnings</h3>
     ...
     window.onload = partnerDashboard();
     </script>
