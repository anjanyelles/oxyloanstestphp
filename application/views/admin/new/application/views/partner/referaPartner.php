 ...
 <div class="content-wrapper">
     ...
     <section class="content-header">
         ...
         <div class="pull-right mobile_reeSection mobile_View_div">
             ...
             <input type="hidden" name="sub_partnereferrer" class="sub_partnereferrer" value="">
                         ...
                         <div class="col-xs-12">
                             <div class="pull-left col-xs-12">
                                 ...
                                 <div class="pull-left col-xs-9 emailcontent">
                                     <ul>
                                         <li>Visit our portal for more information..</li>
                                         <!--    <li>Let us grow as a family, while you are lending money through OXYLOANS, we ourselves a back-up in life for each other in all kinds of times.</li>
                    <li>Every time your friend lends money, He / She will earn interest and you will earn a Reference Fee as shown below: Example: You Referred XYZ || XYZ joined the platform and lent INR 3,00,000.</li>
                    <li>On the first INR 1,00,000 you will get INR 1000 For the second 1-lakh, you will get INR 100 For the third 1-lakh, you will get INR 100. In total, you will get INR 1200.</li> -->
                                             ...
                                             <div class="block-loan">
                                                 ...
                                                 <div class="panel-body" id="userKYCUpload"
                                                     ...
                                                     <div class="pull-left col-xs-5 mobile_ref_7">
                                                         ...
                                                         <div class="form-group row">
                                                             <div class="col-sm-12 ref_radio" style="  position: relative;
                             display: inline-block;display: flex;flex-direction: row;flex-wrap: wrap;">

                                                                 <label for="typeofReferrer" class="col-form-label"
                                                                     style="margin:0px 10px 0px 0px ;padding: 0;">Referrer
                                                                     Type:</label>
                                                                 ...
                                                                 <div class="radio_ref">
                                                                     <input type="radio" name="primaryreferrerType"
                                                                         id="referrerp" value="PARTNER">
                                                                     <span class="Rtype"><b>Partner</b></span>
                                                                 </div>
                                                             </div>
                                                             <span class="error chooseReferrer type"
                                                                 style="display:none">Please select Referrer Type</span>
                                                         </div>
                                             ...
                                             <div class="pull-left classcopyrefLink col-md-12">
                                                 <div>
                                                     <input type="text" id="refLinkU"
                                                         ...
                                                         style="display: none;" />
                                                     <div class="newSTH pull-left">Invite Lender </div>
                        ...
                        btn-ref pull-left" data-toggle="tooltip" title="Share this link" data-placement="right">
                                             ...
                                             <div class="pull-left classcopyrefLink col-md-12">
                                                 ...
                                                 <button onclick="copyBorrowerrefLink('#b_partnerUtm');"
                                                     ...
                                                     title="Share This link" data-placement="bottom">Invite a Borrower
                                                     <i class="fa fa-clipboard fa_copyRefLink"
                                                         aria-hidden="true"></i></button>
                                             ...
                                             <div class="pull-left classcopyrefLink col-md-12">
                                                 ...
                                                 <button onclick="copyNrirefLink('#nrirefLinkU');"
                                                     class="btn btn-info  btn-ref-nri" data-toggle="tooltip"
                                             ...
                                             <div class="pull-left classcopyrefLink col-md-12">
                                                 <input type="text" id="borrowerRefLinkU" style="display: none;"
                                                     value="<?php echo $_SERVER['REQUEST_URI']; ?>" />
                                                 <div class="newSTH pull-left mobile_View_hide">Invite <u><b>
                                                             Partner</b></u> Link </div>
                                                 <button onclick="copyReferresSubLink('.sub_partnereferrer');"
                                                     class="btn btn-primary btn-ref-partner" data-toggle="tooltip"
                                                     title="Share This link" data-placement="bottom">Invite Partner
                                                 </button>
                                     ...
                                     <div class="tab-pane fade col-md-12" id="neobank">
                                         <div class="neoText">
                                             ...
                                             <p class="neo-Oxycontent2 pull-left">Using the following referral links,
                                                 you can launch the p2p lending platform which we are calling a Neo
                                                 bank.</p></br></br></br></br>
                                         </div>
                        ...
                        btn-ref btn-md btn-ref-lender" data-toggle="tooltip" title="Share this link"
                                                         data-placement="left">
                                                         Invite Lender <i class="fa fa-user-o fa_copyRefLink"
                                                             aria-hidden="true"></i> </button>
                                                 </div>
                                             </div>
                                             <div class="clear"></div></br>
                                             ...
                                             <div class="pull-left classcopyrefLink col-md-12">
                                                 <input type="text" id="borrowerRefLinkU" style="display: none;"
                                                     value="<?php echo $_SERVER['REQUEST_URI']; ?>" />
                                                 <div class="newSTH pull-left mobile_View_hide"> <u><b>Borrower</b></u>
                                                     Referral Link </div>
                                                 <button onclick="copyBorrowerrefLink('#b_partnerUtm');"
                                                     class="btn btn-warning btn-ref-borrower" data-toggle="tooltip"
                                                     title="Share This link" data-placement="bottom">Invite a Borrower
                                             ...
                                             <div class="pull-left classcopyrefLink col-md-12">
                                                 ...
                                                 <button onclick="copyReferresSubLink('.sub_partnereferrer');"
                                                     class="btn btn-primary btn-ref-partner" data-toggle="tooltip"
                                                     title="Share This link" data-placement="bottom">Invite
                                                     Partner</button>
             ...
             <div class="modal-body emailcontent">
                 ...
                 <div class="row">
                     ...
                     <p>OxyLoans is founded and run by Mr.RadhakrishnaThatavarti! Please review his linkedin profile, <a
                             ...
                             target="_blank">
                             https://www.linkedin.com/in/venkata-radhakrishna-thatavarti-214b2a213/</a>.
