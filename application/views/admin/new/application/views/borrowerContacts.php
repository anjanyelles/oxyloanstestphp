        ...
        <div class="row customFormQ">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="pull-right">
                            <!--  <button class="btn btn-lg btn-info" type="checkbox" id="selectAll">Invite All</button> -->
                        ...
                        <table id="example2" class="table table-bordered table-hover"><br />
                            ...
                            <tbody id="gmailcontacts">
                                <tr id="gmailContactsNoData" style="display: none;">
                                    <td class="col-md-8">No data found</td>
                                </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body emailcontent">
                ...
                <div class="row">
                    ...
                    <p>Greetings from <i class="usrNameEmail"></i>! I am an existing borrower on OxyLoans.com!
                        OXYLOANS.com is an RBI Approved Peer to Peer Lending Platform. OxyLoans enable every individual
                        to borrow money like a bank/.</p><br />
                    <!-- <p class="getEmailMessage quote-text" id="contentbulk"></p> -->
                    <br />
                    <p><a href="https://www.oxyloans.com/new/register" target="_blank">Please join as a borrower or
                            investor and start borrowing or lending. </a></p>
                    <p></p><br />
                    <p>OxyLoans is founded and run by Mr.RadhakrishnaThatavarti! Please review his linkedin profile, <a
                            href="https://www.linkedin.com/in/thatavartiradhakrishna/"
                            target="_blank">https://www.linkedin.com/in/thatavartiradhakrishna/</a>. I am sending this
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="text1">Thank you for referring. your friend(s).</br>
                </p>
            </div>
            <div class="modal-footer">
                <div align="right">
