...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Ninety one days Borrower Loan Applications
        ...
        <div class="row">
            ...
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn"
                    onclick="searchforBucketdays(91,0,'npa');">
                    ...
                    <div class="box-body">
                        ...
                        <div class="fright">
                            <button class="btn btn-success" class="downloadReport"
                                onclick="downloadNPAReport();">Download Report</button>
                        </div><br>
...
<script id="loadBorrowersListTpl" type="text/template">
   ...
   <td><a href="javascript:void(0)" class="viewLoanLendersforbuckets"onclick="viewbucketLoanLenders(91,0,'npa',{{borrowerUser.id}})" >View Loans</a></td>
  ...
  <td style="display:none;" colspan="14" class="viewbucketLoanLenders viewbucketLoanLenders-{{borrowerUser.id}}">
      ...
      <div class="col-md-6 pull-right">
       ...
       <table class="table table-bordered table-hover">
          ...
          <th>NPA  bucket pending EMI's</th>
              </tr>
              </thead>
...
<script id="loadLendersbucketloans" type="text/template">
    {{#data}}
      ...
      <td>LR{{lenderUser.id}}<br/>{{lenderUser.firstName}} {{lenderUser.lastName}}</td>
        ...
        <td><a href="javascript:void(0)" class="viewDelayEMIcard" onclick="viewDelayEMIcard(91,0,'npa','{{id}}');">View NPA bucket delay EMI</a>
        </td>
      </tr>
  {{/data}}
</script>
...
<div class="modal modal-success fade" id="modal-npabucketdownload">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                NPA bucket downloaded Successfully .
            </div>
...
window.onload = loadPndingbucketsApplications(91, 0, "npa");
