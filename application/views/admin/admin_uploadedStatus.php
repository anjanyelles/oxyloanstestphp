...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <center>Uploaded Status Borrowers</center>
        </h1>
    </section><br />
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn" onclick="statussearch('uploaded')"><i
...
<div class="modal  fade" id="modal-commentss">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-footer">
                <div align="right">
                    <button type="button" class="btn  btn-primary btn-sm saveCommentBtnshow" data-dismiss="modal"
                        data-clickedid="" onclick="notyetreflected()">Save</button>
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
...
<div class="modal modal-danger fade" id="modal-commentNotyet">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                Borrower Status As NotYetReflected.
            </div>
            <div class="modal-footer">
                <div align="right">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<button type="button" class="btn btn-danger pull-left btn-sm"  onclick="showbox({{documentUploadId}})"><b>Reason for disapproval</b></button><br/>
</br>
    </td>
...
<button type="button" class="btn btn-info pull-left btn-sm" onclick="updatestatus({{documentUploadId}})"><b>Verify</b></button><br/>
