    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-xs-3 text-center applicationid" style="display: none;">
                <input type="text" name="applicationid" id="applicationid" class="form-control applicationid"
            ...
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn"
                    onclick="searchsforpendingEmis('feature')">
...
<div class="col-xs-3 text-center">
<button type="button" class="btn bg-gray pull-left search-btn" onclick="loadEMIsBasedOnRequest();"><i class="fa fa-angle-double-right"></i> <b>Search</b>
  </button>
  </div>
</div> -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="col-md-6">
                            <h3 class="box-title">Future Month Pending EMIs</h3>
                        </div>
                    ...
                    <div class="box-body">
                        <div class="fright">
                            <button class="btn btn-success" onclick="javascript:demoFromHTML()">Download Report</button>
    ...
    {{#data}}
     <tr>
      ...
      <td>{{city}}</td>
       ...
       <td><a href="javascript:void(0)" class="viewLoanLendersforpendingemis"onclick="viewLoanLendersforpendingemis('feature',{{borrowerUserId}})" >View Loans</a></td>
      </tr> 
<tr>
...
<script id="loadLenderspendingemisloans" type="text/template">
    {{#data}}
      ...
      <td>LR{{lenderUser.id}}<br/>{{lenderUser.firstName}} {{lenderUser.lastName}}</td>
       ...
       <td><a href="javascript:void(0)" class="viewPendingEMIcard" onclick="viewPendingEMIcard('feature',{{id}})">View EMI</a>
        </td>
      </tr>
  {{/data}}
</script>
...
window.onload = loadPendingEMIsList('feature');
</script>
