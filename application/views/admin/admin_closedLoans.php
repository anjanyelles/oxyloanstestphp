...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn" onclick="searchLoanClosedLoans();"><i
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="col-md-6">
                            <h3 class="box-title">Closed Loans info</h3>
                        </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr id="example">
                                    ...
                                    <th>Emi's Paid</th>
                                    <th>Due Amount</th>
                                    <th>Profit</th>     <?php if ($userType === 'SUPERADMIN'): ?>
                                        <th>Agreement</th>
<?php endif; ?>
                                </tr>
                            </thead>
...
window.onload = loadLoans("Closed");
</script>
<style type="text/css">
