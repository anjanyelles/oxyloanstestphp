                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="col-md-6 runningheader">
                            <a href="salariedDeals?status=running">
                                <button class=" btn btn-success btnRoundUp" style="border-radius: 5px;">
                                    Personal Running Deals <i class="fa fa-angle-double-right"></i>
                                </button>
                            </a>

                            <a href="salariedDeals?status=closed" class="compleated-Btn">
                                <button class=" btn btn-warning btnRoundUp"
                                    style="border-radius: 5px; margin-left: 10px;">
                                    Personal Closed Deals <i class="fa fa-angle-double-right"></i>
                                </button>
                            </a>
    ...
    <script id="displayDealsScript" type="text/template">
      ...
      <tr>
        ...
        <td>
           ...
           To Wallet : {{dealAmountReturnedToWallet}} </br> </br> 
   ...
   <b>Deal Amount : <span class="numdigitsvalues" value="{{dealAmount}}"> {{dealAmount}}</span> </b>
    ...
    {{/emiEndDate}}
        ...
        <td>
          ...
          <a href="viewDealLenders?id={{dealId}}&dealName={{dealName}}">
