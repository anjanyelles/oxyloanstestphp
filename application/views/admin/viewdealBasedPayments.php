                ...
                <div class="box box-secondary">
                    <div class="box-body editlendergroup">
                        ...
                        <div class="col-md-3 text-bold">
                            Current Value : <span class="totalDealCurrentValue">0</span>

                        </div>

                        <div class="col-md-2 text-bold">
                            Interest :<?php echo $totalInterestAmount?>

                        </div>


                        <div class="col-md-3 text-bold">
                            Payment Status : <span class="totalDealPaymentStatus">0</span>
...
window.onload = approveingInterestPay('<?php echo $dealId ?>', '<?php echo $currentMonthPaymentDate?>', 'onhold',
    '<?php echo $totalInterestAmount?>', '<?php echo $orginalPaymentDate?>');
</script>
