        ...
        <div class="container">
            <div class="middle-block">
                <div class="form-block1 block-loan">
                    ...
                    <form id="borrowerCustomizationStep1" autocomplete="off" method="post">
                        <div class="step1">
                            <div class="form-lft">
                            ...
                            <a href="register" class="btn-back" data-toggle="tooltip" title="Back">
                                <button type="submit" class="btn btn-flat f-submitBtn">
                    ...
                    <form id="borrowerCustomizationStep2" autocomplete="off" method="post">
                        <div class="step2" style="display: none;">
                            ...
                            <div class="form-lft hideEmailOtp" style="display: none;">
                                <label>OTP<i>*</i></label>
                                <div class="fld-block">
