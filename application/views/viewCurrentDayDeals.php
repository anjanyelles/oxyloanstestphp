    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="pull-right col-md-9 mobileDiv_2">
                ...
                <a href="viewDeals" class="runningDeals-Btn">
                    <button class=" btn btn-success btnRoundUp pull-right">
                    Other Deals
                    </button>
                </a>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody id="displayDealsData" class="mobileDiv_3">
                                ...
                                <tr style="display: none;" id="displayDelasInfo">
                                    <td colspan="12">No deals found. If you're interested in participating in other deals, kindly  <a href="viewDeals"><button class="btn btn-info btn-xs">click here</button></a></td>
                                </tr>
