...
<script id="displayDealsScript" type="text/template">
    ...
    <td>
       <span class="lable_mobileDiv">&nbsp;</span>
      <a href="ViewBorrowerLoanInfo?userid={{dealMappedToBorrowerId}}&adminID={{adminId}}">
        <button class="btn btn-info btn-sm"><span class="fa fa-eye"></span> View</button>
      </a>
    </td>
  </tr>
  {{/data}}
