        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="input-group date"  data-date-format="dd/mm/yyyy">
                          <input type="text" class="form-control dateofbirthValue " id="dateofbirth" placeholder="DD/MM/YYYY" name="dateofbirth" data validation="dateofbirth" >
                              ...
                              <span class="glyphicon glyphicon-calendar"></span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <!-- <div class="controls">
                   <label   class="col-sm-2 col-form-label"for="gender-0 row">
                   <input name="gender" id="gender-0" value="Male"  type="radio" >
                       Male
                   </label>
                     <label  class="col-sm-2 col-form-label" for="gender-1 row">
                      ...
                      Female
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <!--  <div class="controls">
                   <label   class="col-sm-2 col-form-label"for="maritalStatus-0 row">
                   <input name="maritalStatus" id="maritalStatus-0" value="Married"  type="radio">
                       Married
                   </label>
                     <label  class="col-sm-2 col-form-label" for="maritalStatus-1 row">
                      <input name="maritalStatus" id="maritalStatus-1" value="Single" type="radio">
                      Single
                 </label>
