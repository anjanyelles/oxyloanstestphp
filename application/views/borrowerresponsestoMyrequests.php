...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            Responses to your loan requests.
        </h1>
        ...
        <div class="pull-right mobile_View_div">
            ...
            <a href="myrunningboffers" class="viewLendersOffers">
                <button type="button" class="btn btn-success pull-right marR15"><i class="fa fa-angle-double-right"></i>
                    <b>Requests</b>
                </button>
            </a>
                        ...
                        <div class="row customFormQ">
                            ...
                            <div class="col-md-12">
                                <div id="displayNoRecords" class="displayNoRecords" style="display: none;">
                                    <b>Awaiting response from the Lenders.You will be notified through Email and SMS
              ...
              <div class="box-footer">
                 ...
                 <div class="displayActionButtons-{{loanStatus}} userReacted">
                   <div class="pull-left padt20">
                    ...
                    <a href="javascript:void(0)"  class="resptoLoanar" data-loanRequestId={{loanRequestId}} data-action-type ="Accepted" data-toggle="modal" data-target="#promptAccUser"
                    onclick="userresponding('Accepted', {{loanRequestId}});">
                  ...
                  <div class="pull-right padt20" >
                    <a href="javascript:void(0)"   class="resptoLoanar" data-loanRequestId={{loanRequestId}} data-action-type ="Rejected" data-toggle="modal" data-target="#promptAccUser"
                    onclick="userresponding('Rejected', {{loanRequestId}});">
                      <button type="submit" class="btn btn-danger">Reject</button></a>
                  </div>
                </div>

                <div class="displayAppMessage-{{loanStatus}} loanStatus-sec" style="display:none;">You've {{loanStatus}} this request.</div>
              </div>
...
<div class="modal modal-info fade" id="modal-displaySuggetion">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Your request is sent to the lender.</p>
            </div>
            <div class="modal-footer">
...
<div class="modal modal-warning fade" id="modal-loanAmountlimit">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <p class="text" id="text">you can not</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
            </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success postreqID thisisYESbtn" data-reqID="" data-type=""
