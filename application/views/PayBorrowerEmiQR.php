...
$loanId =  isset($_GET['loanId']) ? $_GET['loanId'] : '0';
$Emino =  isset($_GET['Emino']) ? $_GET['Emino'] : '0';
?>
...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Pay Your Emi Through QR Code
        </h1>
        <div class="pull-right">
            <small>

                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="borrowerDashboard"><i class="fa fa-dashboard"></i>Home</a></li>
                ...
                <div class="box-body">
                    <div class="qrbox-info">
                        <div class="qrbox-text">
                            <h1><i class="fa fa-qrcode" aria-hidden="true"></i> Pay Your Emi</h1>
                            <div>
                                <input type="text" name="qrAmount" placeholder="Enter The amount" id="bqrAmountValue">
                            ...
                            <div>
                                ...
                                <CENTER>
                                    <button type="Submit" class="btn btn-info btn-lg" style="margin-top:15px;"
                                        id="borrowergenQRcode"
                                        onclick="borrowerqrpayout('<?php echo$loanId ?>', <?php echo $Emino ?>)" ,>
                                        SUBMIT </button>
                                </CENTER>
                            </div>
                    ...
                    <div class="displayHelpVideoSection">
                        <h1>How to Pay Your Emi Through QR</h1>
