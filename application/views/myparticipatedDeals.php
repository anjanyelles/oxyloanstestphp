...
// echo "<script type='text/javascript'>alert('$isValidityExpire');</script>";
                    ...
                    <div class="box-header">
                        <div class="col-md-3">
                            <div class="search-container">
                                <form action="#">
                                    ...
                                    <input type="text" placeholder="Search Deal Info" name="search"
                                        id="searchCallofMyDeals" autocomplete="off">
                        ...
                        <div class="col-md-2 pull-left" style="display:none;">
                            <button class="btn btn-success btn-md pull-right"
                                ...
                                onclick="downloadOverallRunningandclosedINFO('RUNNING');"><span class="fa fa-download">
                                </span> Overall
                                Download</button>
                        </div>
            ...
            <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <!--   <div class="col-xs-3 pull-right">
                        <h4 class="modal-title">Earned Amount : <span class="addedAmountInterestEarned"></span> </h4>
                    </div> -->
                </div>
            </div>
...
<div class="modal modal-warning fade" id="modal-participateErrorMessage">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    {{#data}}
        ...
        <td><span class="lable_mobileDiv">Deal Name</span>
         <b class="mobile_View_Hide" >Deal Name </br> </b> {{dealName}}</br>
           <b class="mobile_View_Hide"> Deal ID  : </b> {{dealId}} </br>
          <b class="mobile_View_Hide"> Deal Type  : </b> {{dealType}} </br>
           <b class="mobile_View_Hide">First Interest :</b> {{firstInterestDate}}</br>
              <b class="mobile_View_Hide">Fee Status :</b> {{feeStatus}}</br>

             <!-- <b class="mobile_View_Hide hideAvaliable_{{lenderRemainingPanLimit}}{{lenderPaticipateStatus}}">Remaining Pan Limit   :  {{lenderRemainingPanLimit}}  </b>  -->
            ...
            <div class="feestatus feestatus_{{feeStatus}} style="display:none">
            <span class="feeTextMessage">Processing Fee Pending</span></br>
            <b class="mobile_View_Hide">Amount </b>: INR {{processingFee}} </br>
         
            <button class="btn btn-xs btn-danger" onclick="paymemberShipFeeOnParticipatedDeals('{{dealId}}', '{{processingFee}}');">Pay Membership</button>
          </div>
...
updatenewmembershipLenderFeeDetails(<?php echo "'";?><?php echo $orderId; ?><?php echo "'";?>, <?php echo "'";?><?php echo $referenceId; ?><?php echo "'";?>,
   ...
   $("#modal-participated-membership").modal("show");
</script>
<?php } ?>
